...
function PulseCore() {
  return (
    <div className="db-core-wrap" aria-label="AETHER system core">
...
function VoiceCard({ voice, messages }: { voice: UseVoiceReturn; messages: ChatMessage[] }) {
  ...
  const speakingLabel =
    voiceState === "speaking" ? "AETHER is speaking..."
        ...
        <div className="db-voice-right">
          ...
          {recentMessages.length > 0 ? (
            recentMessages.map((msg) => {
              ...
              const isAether = msg.role === "assistant";
              ...
              return (
                <div className="db-transcript-line" key={msg.id}>
                  ...
                  <span className={`db-transcript-text ${isAether ? "db-transcript-aether" : ""}`}>
                    {text}
                  </span>
                </div>
              );
