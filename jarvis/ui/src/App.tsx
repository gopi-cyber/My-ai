...
export function App() {
  ...
  return (
    <div style={{ display: "flex", height: "100dvh", width: "100vw", background: "var(--bg-void)", position: "relative" }}>
      {/* Sidebar — Restored full width navigation */}
      <nav 
      ...
      >
        ...
        <div className="sidebar-logo-row">
          ...
          />
          <span className="sidebar-logo-text">{identity.name || "J.A.R.V.I.S."}</span>
        </div>
