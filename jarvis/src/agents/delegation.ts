...
export async function delegateTask(
  ...
  const commitment = await createCommitment(task.what, {
  ...
  const message = await sendMessage(parent.id, child.id, 'task', task.what, {
...
export async function reportCompletion(
  ...
  await sendMessage(child.id, parent.id, 'report', content, {
