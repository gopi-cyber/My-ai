...
describe('Personality Engine', () => {
  ...
  describe('Model', () => {
    test('should get default personality', async () => {
    ...
    test('should save and load personality', async () => {
      const personality = await loadPersonality();
  ...
  describe('Learner', () => {
    ...
    test('should record interactions and increase trust', () => {
      ...
      expect(personality.relationship.trust_level).toBeGreaterThan(6); // 3 (initial) + 50/10 = 8
    });
  });
  ...
  describe('Integration', () => {
    test('should handle full learning cycle', async () => {
      // Start with default personality
      let personality = await loadPersonality();
      const initialVerbosity = personality.learned_preferences.verbosity;
